							   ...
							   Map<String, Object> extraClaims ) 
	{
		...
		String jwt = Jwts.builder()
				...
				.header()
					...
					.and()	
				//PAYLOAD del JWT
				.subject(objUser.getUsername()) // propietario
				.issuedAt(issuedAt) // Tiempo de creación
				.expiration(expiration) // Tiempo de expiración
				.claims(extraClaims) // Claims o información afirmada del token.
				.signWith(generatedkey(),Jwts.SIG.HS256) // La firma del token con la clave secreta y el algoritmo HS256 (estandar más utilizado).
				.compact();// por ultimo lo creamos con el método compact().	
